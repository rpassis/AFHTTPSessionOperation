...
//! Project version number for AFSessionOperation.
FOUNDATION_EXPORT double AFSessionOperationVersionNumber;

//! Project version string for AFSessionOperation.
FOUNDATION_EXPORT const unsigned char AFSessionOperationVersionString[];
